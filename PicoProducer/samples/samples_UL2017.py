...
samples  = [
  ...
  M('ST','ST_t-channel_top',
    "/ST_t-channel_top_5f_InclusiveDecays_TuneCP5_13TeV-powheg-pythia8/RunIISummer19UL17NanoAODv2-106X_mc2017_realistic_v8-v1/NANOAODSIM", # BUGGY Summer19, 20 still in prod
    store=storage,url=url,files=filelist,opts="useT1=True"),
  M('ST','ST_s-channel',
    '/ST_s-channel_4f_leptonDecays_TuneCP5_13TeV-amcatnlo-pythia8/RunIISummer20UL17NanoAODv2-106X_mc2017_realistic_v8-v1/NANOAODSIM',
    store=storage,url=url,files=filelist,opts="useT1=True"),
  ...
  D('Data','SingleElectron_Run2017C',"/SingleElectron/Run2017C-UL2017_MiniAODv1_NanoAODv2-v1/NANOAOD", 
    store=storage,url=url,files=filelist,opts="useT1=False",channels=["skim*",'etau','ee','eetau']),
  ...
  D('Data','SingleElectron_Run2017E',"/SingleElectron/Run2017E-UL2017_MiniAODv1_NanoAODv2-v2/NANOAOD",
    store=storage,url=url,files=filelist,opts="useT1=False",channels=["skim*",'etau','ee','eetau']),
  D('Data','SingleElectron_Run2017F',"/SingleElectron/Run2017F-UL2017_MiniAODv1_NanoAODv2-v3/NANOAOD",
    store=storage,url=url,files=filelist,opts="useT1=False",channels=["skim*",'etau','ee','eetau']),
  ...
  D('Data','Tau_Run2017D',"/Tau/Run2017D-UL2017_MiniAODv1_NanoAODv2-v1/NANOAOD",
    store=storage,url=url,files=filelist,opts="useT1=False",channels=["skim*",'tautau']),
  D('Data','Tau_Run2017E',"/Tau/Run2017E-UL2017_MiniAODv1_NanoAODv2-v2/NANOAOD",
    store=storage,url=url,files=filelist,opts="useT1=False",channels=["skim*",'tautau']),
