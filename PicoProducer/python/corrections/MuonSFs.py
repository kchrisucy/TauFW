  ...
  def __init__(self, era='2017', verb=0):
    ...
    if 'UL' in era:
      if '2016' in era and 'preVFP' in era:
        ...
        sftool_id         = ScaleFactor(pathPOG+"Run2016UL_preVFP/Efficiencies_muon_generalTracks_Z_Run2016_UL_HIPM_ID.root","NUM_TightID_DEN_TrackerMuons_abseta_pt",'mu_id',ptvseta=True,verb=verb)
        ...
        self.sftool_trig  = ScaleFactor(pathPOG+"Run2016UL_postVFP/Efficiencies_muon_generalTracks_Z_Run2016_UL_SingleMuonTriggers.root",
                                           'NUM_IsoMu24_or_IsoTkMu24_DEN_CutBasedIdTight_and_PFIsoTight_eta_pt','mu_trig',verb=verb)
        sftool_id         = ScaleFactor(pathPOG+"Run2016UL_postVFP/Efficiencies_muon_generalTracks_Z_Run2016_UL_ID.root","NUM_TightID_DEN_TrackerMuons_abseta_pt",'mu_id',ptvseta=True,verb=verb)
        ...
        sftool_id         = ScaleFactor(pathPOG+"Run2017UL/Efficiencies_muon_generalTracks_Z_Run2017_UL_ID.root","NUM_TightID_DEN_TrackerMuons_abseta_pt",'mu_id',ptvseta=True,verb=verb)
        ...
        sftool_id         = ScaleFactor(pathPOG+"Run2018UL/Efficiencies_muon_generalTracks_Z_Run2018_UL_ID.root","NUM_TightID_DEN_TrackerMuons_abseta_pt",'mu_id',ptvseta=True,verb=verb)
