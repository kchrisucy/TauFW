...
def getsampleset(channel,era,**kwargs):
  ...
  if 'UL' in era: # UltraLegacy
    expsamples = [ # table of MC samples to be converted to Sample objects
      ...
      ( 'DY', "DYJetsToLL_M-50",       "Drell-Yan 50",        5343.0  ), # apply k-factor in stitching
  ...
  elif channel in ['mumutau']: #kc, added mumutau
    weight = "trigweight*puweight*idisoweight_1*idisoweight_2*ltfweight_tau"
  ...
  sampleset.join('VV','TT','ST','DY','QCD','WJ', name='Simulation')
