...
def getsampleset(channel,era,**kwargs):
  ...
  if weight=="":
    ...
    #weight = "genweight*trigweight*puweight*idisoweight_1*ltfweight_tau" # ltfweight_tau 
    weight = "genweight*trigweight*puweight*idisoweight_1*ltfweight_tau" # lsingletfweight_tau 
  else: # mumu, emu, ...
